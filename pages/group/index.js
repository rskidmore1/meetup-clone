      ...
      <div className='flex flex-col content-center gap-5 w-1/3'>
        <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-row">
            ...
            <span className="text-gray-600 mx-2">(586)</span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
          ...
          <div className="flex flex-row">
            ...
            <div>Organized by <span className="font-bold">Ryan</span> and <span className="font-bold">1 other</span></div>
          </div>
          <div className="flex flex-row text-blue-500 mt-4">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
